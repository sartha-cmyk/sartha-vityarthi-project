...
○ Accepts AQI values as input
○ Uses lists and loops for data processing
○ Computes average AQI.
○ Displays weekly/daily AQI summary
○ Detects the most polluted day
○ Finds days exceeding a pollution threshold
...
1 AQI: 50, 60, 40 Average = 50; Category = Good/Satisfactory
2 AQI: 120, 150, 200 Average = Moderate/Poor
3 Threshold = 100 Days above threshold identified
4 Highest AQI = 280 Displays correct worst day
